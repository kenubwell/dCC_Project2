...
class Battlefield:
    ...
    def run_game(self): # call all of our other functions here to run the game
    ...
    def battle(self):
        ...
        while match_off is False:
            ...
            if turn == 1:
                if self.herd.dinosaurs[0].health > 0 or self.herd.dinosaurs[1].health > 0 or self.herd.dinosaurs[2].health > 0:
                    self.robo_turn()
